...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_artworks_category" AS ENUM('Paintings', 'Drawings', 'Intaglio', 'Ceramics', 'Watercolor');
  ...
  CREATE TABLE "site_settings_exhibitions" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "site_settings_volunteering" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"year" varchar NOT NULL,
  ...
  CREATE TABLE "site_settings" (
  	...
  	"home_featured_eyebrow" varchar,
  	"home_featured_title" varchar,
  	"home_closing_eyebrow" varchar,
  	"home_closing_heading" varchar,
  	"about_cta_heading" varchar,
  	"artist_portrait_id" integer,
  	"artist_portrait_alt" varchar,
  ...
  ALTER TABLE "site_settings_exhibitions" ADD CONSTRAINT "site_settings_exhibitions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "site_settings_volunteering" ADD CONSTRAINT "site_settings_volunteering_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "site_settings" ADD CONSTRAINT "site_settings_artist_portrait_id_media_id_fk" FOREIGN KEY ("artist_portrait_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "site_settings_exhibitions_order_idx" ON "site_settings_exhibitions" USING btree ("_order");
  CREATE INDEX "site_settings_exhibitions_parent_id_idx" ON "site_settings_exhibitions" USING btree ("_parent_id");
  CREATE INDEX "site_settings_volunteering_order_idx" ON "site_settings_volunteering" USING btree ("_order");
  CREATE INDEX "site_settings_volunteering_parent_id_idx" ON "site_settings_volunteering" USING btree ("_parent_id");
  CREATE INDEX "site_settings_hero_image_idx" ON "site_settings" USING btree ("hero_image_id");
  CREATE INDEX "site_settings_artist_portrait_idx" ON "site_settings" USING btree ("artist_portrait_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_settings_exhibitions" CASCADE;
  DROP TABLE "site_settings_volunteering" CASCADE;
